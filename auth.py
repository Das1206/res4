...
def signup(): # define the sign up function
    if request.method=='GET': # If the request is GET we return the sign up page and forms
        ...
        # === EDIT: updated to automatically generate random id
        new_user = User(id=random.randint(0,10000),email=email, name=name, password=generate_password_hash(password, method='sha256')) #
